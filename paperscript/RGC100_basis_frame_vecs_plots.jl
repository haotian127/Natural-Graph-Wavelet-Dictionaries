...
# gplot(W, X; width=1); scatter_gplot!(X; marker = sc_wavelet_1_698, c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_nDAG_SC_Frame_wavelet_1_698")
#
# sc_wavelet_2_698 = [CSV.File(joinpath(@__DIR__, "..", "datasets", "wavelet_2_698.csv"); delim=",", header = false)[1][k] for k in 1:N]
# gplot(W, X; width=1); scatter_gplot!(X; marker = sc_wavelet_2_698, c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_nDAG_SC_Frame_wavelet_2_698")
#
# sc_wavelet_1_784 = [CSV.File(joinpath(@__DIR__, "..", "datasets", "wavelet_1_784.csv"); delim=",", header = false)[1][k] for k in 1:N]
# gplot(W, X; width=1); scatter_gplot!(X; marker = sc_wavelet_1_784, c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_nDAG_SC_Frame_wavelet_1_784")
#
# sc_wavelet_2_784 = [CSV.File(joinpath(@__DIR__, "..", "datasets", "wavelet_2_784.csv"); delim=",", header = false)[1][k] for k in 1:N]
# gplot(W, X; width=1); scatter_gplot!(X; marker = sc_wavelet_2_784, c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_nDAG_SC_Frame_wavelet_2_784")
#
# sc_wavelet_1_977 = [CSV.File(joinpath(@__DIR__, "..", "datasets", "wavelet_1_977.csv"); delim=",", header = false)[1][k] for k in 1:N]
# gplot(W, X; width=1); scatter_gplot!(X; marker = sc_wavelet_1_977, c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_nDAG_SC_Frame_wavelet_1_977")
#
# sc_wavelet_2_977 = [CSV.File(joinpath(@__DIR__, "..", "datasets", "wavelet_2_977.csv"); delim=",", header = false)[1][k] for k in 1:N]
# gplot(W, X; width=1); scatter_gplot!(X; marker = sc_wavelet_2_977, c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_nDAG_SC_Frame_wavelet_2_977")
...
lvl = 3; i = 1; k = 25; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_dual[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
savefig(plt, "paperfigs/RGC100_DAG_PC_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_father_wavelet")

# Mother wavelet
lvl = 3; i = 2; k = 43; gplot(W, X; width=1); scatter_gplot!(X; marker = -wavelet_packet_dual[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
savefig(plt, "paperfigs/RGC100_DAG_PC_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_mother_wavelet")
# node = findmax(wavelet_packet_dual[lvl][i][:,k].^2)[2]; print("location: ", node)
# scatter_gplot(X; marker = spike(node, N))

# Packet wavelet
lvl = 3; i = 3; k = 100; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_dual[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
savefig(plt, "paperfigs/RGC100_DAG_PC_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_wavelet_packet_vec")


# Level 3
# Father wavelet
print("location: ", sortperm(wavelet_packet_dual[lvl][i][node,:].^2, rev = true)[1:5])
lvl = 4; i = 1; k = 7; gplot(W, X; width=1); scatter_gplot!(X; marker = -wavelet_packet_dual[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
savefig(plt, "paperfigs/RGC100_DAG_PC_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_father_wavelet")

# Mother wavelet
lvl = 4; i = 2; k = 4; gplot(W, X; width=1); scatter_gplot!(X; marker = -wavelet_packet_dual[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
savefig(plt, "paperfigs/RGC100_DAG_PC_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_mother_wavelet")

# Packet wavelet
lvl = 4; i = 3; k = 25; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_dual[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
savefig(plt, "paperfigs/RGC100_DAG_PC_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_wavelet_packet_vec")
...
# # Father wavelet
# print("location: ", sortperm(wavelet_packet_dual[lvl][i][node,:].^2, rev = true)[1:5])
# lvl = 5; i = 1; k = 1; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_dual[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_PC_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_father_wavelet")
# node = findmax(wavelet_packet_dual[lvl][i][:,k].^2)[2]; print("location: ", node) # node = 698
# # scatter_gplot(X; marker = spike(node, N))
#
# # Mother wavelet
# lvl = 5; i = 2; k = 20; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_dual[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_PC_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_mother_wavelet")
# node = findmax(wavelet_packet_dual[lvl][i][:,k].^2)[2]; print("location: ", node) # node = 784
# # scatter_gplot(X; marker = spike(node, N))
#
# # Packet wavelet
# lvl = 5; i = 5; k = 7; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_dual[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_PC_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_wavelet_packet_vec")
...
# # Level 5
# # Father wavelet
# lvl = 6; i = 1; k = 3; gplot(W, X; width=2); scatter_gplot!(X; marker = wavelet_packet_dual[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_PC_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_father_wavelet")
# # node = findmax(wavelet_packet_dual[lvl][i][:,k].^2)[2]; print("location: ", node)
# # scatter_gplot(X; marker = spike(node, N))
# # Mother wavelet
# lvl = 6; i = 2; k = 11; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_dual[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_PC_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_mother_wavelet")
# # node = findmax(wavelet_packet_dual[lvl][i][:,k].^2)[2]; print("location: ", node)
# # scatter_gplot(X; marker = spike(node, N))
#
# # Packet wavelet
# lvl = 6; i = 10; k = 5; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_dual[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_PC_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_wavelet_packet_vec")
# # node = findmax(wavelet_packet_dual[lvl][i][:,k].^2)[2]; print("location: ", node)
# # scatter_gplot(X; marker = spike(node, N))
...
lvl = 3; i = 1; k = 8; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_father_wavelet")

# Mother wavelet
lvl = 3; i = 2; k = 122; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_mother_wavelet")
# node = findmax(wavelet_packet_dual[lvl][i][:,k].^2)[2]; print("location: ", node)
# scatter_gplot(X; marker = spike(node, N))

# Packet wavelet
lvl = 3; i = 3; k = 297; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_wavelet_packet_vec")


# Level 3
# Father wavelet
print("location: ", sortperm(wavelet_packet_varimax[lvl][i][node,:].^2, rev = true)[1:5])
lvl = 4; i = 1; k = 8; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_father_wavelet")

# Mother wavelet
lvl = 4; i = 2; k = 3; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_mother_wavelet")

# Packet wavelet
lvl = 4; i = 3; k = 26; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_wavelet_packet_vec")
...
# # Level 3
# # Father wavelet
# lvl = 4; i = 1; k = 4; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_father_wavelet")
#
# # Mother wavelet
# lvl = 4; i = 2; k = 57; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_mother_wavelet")
#
# # Packet wavelet
# lvl = 4; i = 3; k = 29; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_wavelet_packet_vec")
#
#
# # Level 4
# # Father wavelet
# lvl = 5; i = 1; k = 4; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_father_wavelet")
#
# # Mother wavelet
# lvl = 5; i = 2; k = 50; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_mother_wavelet")
#
# # Packet wavelet
# lvl = 5; i = 5; k = 29; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_wavelet_packet_vec")
#
#
#
# # Level 5
# # Father wavelet
# lvl = 6; i = 1; k = 4; gplot(W, X; width=2); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_father_wavelet")
# # node = findmax(wavelet_packet_dual[lvl][i][:,k].^2)[2]; print("location: ", node)
# # scatter_gplot(X; marker = spike(node, N))
#
# # Mother wavelet
# lvl = 6; i = 2; k = 12; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_mother_wavelet")
# # node = findmax(wavelet_packet_dual[lvl][i][:,k].^2)[2]; print("location: ", node)
# # scatter_gplot(X; marker = spike(node, N))
#
# # Packet wavelet
# lvl = 6; i = 10; k = 13; gplot(W, X; width=1); scatter_gplot!(X; marker = wavelet_packet_varimax[lvl][i][:,k], c = :viridis, ms = 3); plt = plot!(aspect_ratio = 1, grid = false, xlim = [-250, 250], ylim = [-250, 250])
# savefig(plt, "paperfigs/RGC100_DAG_VM_NGWP_lvl$(lvl-1)_i$(i-1)_k$(k-1)_wavelet_packet_vec")
# # node = findmax(wavelet_packet_dual[lvl][i][:,k].^2)[2]; print("location: ", node)
# # scatter_gplot(X; marker = spike(node, N))
