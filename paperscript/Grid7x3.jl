...
plt = current()
# savefig(plt, "paperfigs/Grid_DAG_2levels_partition.png")
display(plt)


## import NGWP packages
...
plt = current()
# savefig(plt, "paperfigs/Grid7x3_DAG_VM_NGWP_lvl2_wavelets.png")
...
plt = current()
# savefig(plt, "paperfigs/Grid7x3_DAG_PC_NGWP_lvl2_wavelets.png")
